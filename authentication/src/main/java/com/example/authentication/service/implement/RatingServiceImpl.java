...
public class RatingServiceImpl implements RatingService {
    ...
    @Override
    public Map<String, Object> getRatingsWithProductID(Long productID) throws Exception {
        try{
            RatingEntity ratingEntity = ratingRepository.findRatingEntityWithProductID(productID).isPresent()
                    ? ratingRepository.findRatingEntityWithProductID(productID).get() : null;
    ...
    @Override
    public Boolean updateRatingWithProductID(Rating rating, Long productID) throws Exception {
        try {
            RatingEntity ratingEntity = ratingRepository.findRatingEntityWithProductID(productID).isPresent()
                    ? ratingRepository.findRatingEntityWithProductID(productID).get() : null;
            assert ratingEntity != null;
            ...
            throw new Exception("Could not find specific product", e);
        }
    }
}
